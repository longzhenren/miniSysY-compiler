...
public class Visitor extends scBaseVisitor<Void> {
    ...
    public boolean ident_Check_Reg_this_Block(RuleContext ctx, String Ident) {
        ...
        while (!(parent instanceof scParser.BlockContext || parent instanceof scParser.CompUnitContext)) {
    ...
    public boolean ident_Check_Reg(RuleContext ctx, String Ident) {
        ...
        while (!(parent instanceof scParser.CompUnitContext)) {
            if (parent instanceof scParser.BlockContext) {
                if (block_ident_Reg.containsKey(parent)) {
    ...
    public Void visitCompUnit(scParser.CompUnitContext ctx) {
    ...
    @Override
    // bType:INT_KW;
    public Void visitBType(scParser.BTypeContext ctx) {
    ...
    public Void visitDecl(scParser.DeclContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (ctx.parent instanceof scParser.CompUnitContext) {
    ...
    public Void visitConstDecl(scParser.ConstDeclContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        visit(ctx.bType());
        ...
        for (scParser.ConstDefContext cdf : ctx.constDef()) {
    ...
    public Void visitConstDef(scParser.ConstDefContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        String thisReg;
        ...
        if (ctx.constExp().size() != 0) {
            ...
            for (scParser.ConstExpContext ce : ctx.constExp()) {
                visit(ce);
    ...
    public Void visitConstInitVal(scParser.ConstInitValContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (ctx.constExp() != null) {
            ...
            if (ctx.parent instanceof scParser.ConstDefContext) {
            ...
            for (int i = 0; i < ctx.constInitVal().size(); i++) {
                index.add(i);
//            for (scParser.InitValContext i : ctx.initVal()) {//一个括号内部
...
//                        arr_index_val.put(String.valueOf(pos++), expval);
    ...
    public Void visitVarDecl(scParser.VarDeclContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        visit(ctx.bType());
        ...
        for (scParser.VarDefContext vdf : ctx.varDef()) {
...
//            if (ident_Reg.containsKey(Ident) || constIdent_Val.containsKey(Ident)) {
    ...
    public Void visitVarDef(scParser.VarDefContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        String thisReg;
        String Ident = ctx.Ident().getText();
    ...
    public Void visitInitVal(scParser.InitValContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
        ...
        if (ctx.exp() != null) {
            ...
            if (ctx.parent instanceof scParser.VarDefContext) {
                arr_index_val = new HashMap<>();
                arrsize = (ArrayList<Integer>) node_attr_Val.get(ctx.parent).get("size");
                arr_index_val = new HashMap<>();
                attr_Val.put("arr_index_val", arr_index_val);
...
//                        arr_index_val.put(String.valueOf(pos++), expval);
    ...
    public Void visitFuncType(scParser.FuncTypeContext ctx) {
        HashMap<String, Object> attr_val = new HashMap<>();
        node_attr_Val.put(ctx, attr_val);
        if (ctx.INT_KW() != null)
    ...
    public Void visitFuncDef(scParser.FuncDefContext ctx) {
        HashMap<String, Object> attr_val = new HashMap<>();
        node_attr_Val.put(ctx, attr_val);
        visit(ctx.funcType());
        String Ident = ctx.Ident().getText();
...
//    funcFParams: funcFParam ( ',' funcFParam )*;
    public Void visitFuncFParams(scParser.FuncFParamsContext ctx) {
        HashMap<String, Object> attr_val = new HashMap<>();
        node_attr_Val.put(ctx, attr_val);
        ...
        for (scParser.FuncFParamContext fpc : ctx.funcFParam()) {
            visit(fpc);
...
//    funcFParam : bType Ident (LBracket RBracket ( LBracket exp RBracket )*)?;
    public Void visitFuncFParam(scParser.FuncFParamContext ctx) {
        HashMap<String, Object> attr_val = new HashMap<>();
        node_attr_Val.put(ctx, attr_val);
        String Ident = ctx.Ident().getText();
    ...
    public Void visitBlock(scParser.BlockContext ctx) {
        ...
        for (scParser.BlockItemContext bi : ctx.blockItem()) {
            visit(bi);
        }
        return null;
    }
    ...
    @Override
    // blockItem:decl|stmt;
    public Void visitBlockItem(scParser.BlockItemContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (ctx.stmt() != null) {
        ...
        if (ctx.parent instanceof scParser.StmtContext) {
            visit(ctx.stmt());
        }
        return null;
    }
    ...
    public Void visitStmt(scParser.StmtContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
    ...
    public Void visitLVal(scParser.LValContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        String Ident = ctx.Ident().getText();
...
//                    idtype = idtype.substring(0, idtype.length() - 1);
    ...
    public Void visitReturnStmt(scParser.ReturnStmtContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (ctx.exp() != null) {
            visit(ctx.exp());
...
//            String bType = reg_Type.get(expReg);
    ...
    @Override
    // constExp:addExp;
    public Void visitConstExp(scParser.ConstExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        visit(ctx.addExp());
    ...
    @Override
    // exp:addExp;
    public Void visitExp(scParser.ExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitAddExp(scParser.AddExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitMulExp(scParser.MulExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
...
//    unaryExp: Ident LParser (exp ( ',' exp)*)? RParser | ( ADD | SUB | NOT ) unaryExp | primaryExp;
    public Void visitUnaryExp(scParser.UnaryExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitPrimaryExp(scParser.PrimaryExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitRelExp(scParser.RelExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
    ...
    public Void visitEqExp(scParser.EqExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
    ...
    @Override
    // number:intConst;
    public Void visitNumber(scParser.NumberContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitIntConst(scParser.IntConstContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        long res = 0L;
