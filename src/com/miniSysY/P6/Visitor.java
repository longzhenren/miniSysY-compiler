...
public class Visitor extends P6BaseVisitor<Void> {
    ...
    public boolean ident_Check_Reg_this_Block(RuleContext ctx, String Ident) {
        ...
        while (!(parent instanceof P6Parser.BlockContext || parent instanceof P6Parser.CompUnitContext)) {
    ...
    public boolean ident_Check_Reg(RuleContext ctx, String Ident) {
        ...
        while (!(parent instanceof P6Parser.CompUnitContext)) {
            if (parent instanceof P6Parser.BlockContext) {
                if (block_ident_Reg.containsKey(parent)) {
...
//    }
    ...
    @Override
    // blockItem:decl|stmt;
    public Void visitBlockItem(P6Parser.BlockItemContext ctx) {
        ...
        if (ctx.parent instanceof P6Parser.StmtContext) {
            visit(ctx.stmt());
        }
        return null;
    }
    ...
    @Override
    // lVal:Ident;
    public Void visitLVal(P6Parser.LValContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
    ...
    public Void visitDecl(P6Parser.DeclContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (ctx.parent instanceof P6Parser.CompUnitContext) {
    ...
    public Void visitConstDecl(P6Parser.ConstDeclContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        visit(ctx.bType());
        ...
        for (P6Parser.ConstDefContext cdf : ctx.constDef()) {
    ...
    @Override
    // bType:INT_KW;
    public Void visitBType(P6Parser.BTypeContext ctx) {
        if (ctx.INT_KW() != null) {
    ...
    public Void visitConstDef(P6Parser.ConstDefContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        String Ident = ctx.Ident().getText();
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
    ...
    public Void visitConstInitVal(P6Parser.ConstInitValContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        visit(ctx.constExp());
    ...
    @Override
    // constExp:addExp;
    public Void visitConstExp(P6Parser.ConstExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        visit(ctx.addExp());
    ...
    public Void visitVarDecl(P6Parser.VarDeclContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        visit(ctx.bType());
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
        ...
        for (P6Parser.VarDefContext vdf : ctx.varDef()) {
...
//        node_attr_Val.put(ctx, attr_Val);
    ...
    public Void visitVarDef(P6Parser.VarDefContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        String thisReg;
        String Ident = ctx.Ident().getText();
    ...
    @Override
    // initVal:exp;
    public Void visitInitVal(P6Parser.InitValContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitCompUnit(P6Parser.CompUnitContext ctx) {
        if (ctx.decl().size() > 0) {
            for (P6Parser.DeclContext dcx : ctx.decl()) {
                visit(dcx);
            }
        }
        visit(ctx.funcDef());
    ...
    @Override
    // funcType:INT_KW;
    public Void visitFuncType(P6Parser.FuncTypeContext ctx) {
    ...
    @Override
    // funcIdent:FuncIdent;
    public Void visitFuncIdent(P6Parser.FuncIdentContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
    ...
    public Void visitFuncDef(P6Parser.FuncDefContext ctx) {
        visit(ctx.funcType());
        visit(ctx.funcIdent());
    ...
    public Void visitBlock(P6Parser.BlockContext ctx) {
        for (P6Parser.BlockItemContext bi : ctx.blockItem()) {
            visit(bi);
        }
        return null;
    }
    ...
    public Void visitStmt(P6Parser.StmtContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
    ...
    @Override
    // number:intConst;
    public Void visitNumber(P6Parser.NumberContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitIntConst(P6Parser.IntConstContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        long res = 0L;
    ...
    public Void visitReturnStmt(P6Parser.ReturnStmtContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        visit(ctx.exp());
        if (node_attr_Val.get(ctx.exp()).containsKey("thisReg")) {
    ...
    @Override
    // exp:addExp;
    public Void visitExp(P6Parser.ExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitAddExp(P6Parser.AddExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitMulExp(P6Parser.MulExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    // )+)* RParser;
    public Void visitUnaryExp(P6Parser.UnaryExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    public Void visitPrimaryExp(P6Parser.PrimaryExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        if (node_attr_Val.get(ctx.parent).containsKey("global")) {
            attr_Val.put("global", "global");
    ...
    @Override
    // cond:lOrExp
    public Void visitCond(P6Parser.CondContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
        visit(ctx.lOrExp());
        String thisReg = "%x" + currentReg++;
    ...
    public Void visitRelExp(P6Parser.RelExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
    ...
    public Void visitEqExp(P6Parser.EqExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
    ...
    public Void visitLAndExp(P6Parser.LAndExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
    ...
    public Void visitLOrExp(P6Parser.LOrExpContext ctx) {
        HashMap<String, Object> attr_Val = new HashMap<>();
        node_attr_Val.put(ctx, attr_Val);
